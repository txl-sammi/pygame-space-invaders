...
from src.constants import BLACK, ENEMY_SPEED, WHITE, SCREEN_H, SCREEN_W, NUMBER_OF_SHIELDS, MAX_PER_ROW, INITIAL_NUM_ENEMIES, EXTRA_ENEMY_SPEED_PER_LEVEL, EXTRA_ENEMIES_PER_LEVEL, ENEMY_OFFSET, ROW_GAP
